...
struct iptmpl {
    QIRD  * I603;
    struct vcs_globals_t * I604;
    void * I606;
    UP  I607;
    UP  I608;
    struct iptmpl * I601[2];
};
typedef unsigned long long FileOffset;
typedef struct _hsimPeriodL {
    char  I742[256];
    struct _hsimPeriodL * I714;
} HsimPeriodL;
typedef struct {
    U   I744[2];
    U  I745 :1;
...
struct dummyq_struct {
    ...
    struct futq * I859;
    struct futq * I860;
    struct sched_table * I861;
    struct millenium * I863;
    EBLK  * I865;
    EBLK  * I866;
    EBLK  * I867;
    EBLK  * I868;
